  ...
  return (
    <Row className=" bg-light my-3 rounded">
      <Col
        xs={5}
        sm={3}
        className="text-center d-flex flex-column justify-content-around align-items-center py-1"
      >
      ...
      <Col
        xs={6}
        sm={5}
        className="d-flex flex-column justify-content-between align-items-start bd-highlight mb-3"
      >
        <Row className="text-right mt-3">
          <Col xs={12} className="h4 pl-0">
            {props.product.name}
          </Col>
        ...
        <Row xs={12}>
          <Col>
            <Button
              onClick={removeProductHandler}
              variant="danger"
              className="py-0 d-none d-sm-block"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
      ...
      <Col
        xs={0}
        sm={3}
        className="d-none d-sm-flex justify-content-end align-items-end mb-4"
      >
